...
cv.rectangle(canvas, (0, 830), (W, 960), (145, 118, 88), cv.FILLED)   # river body (steel blue-gray)
cv.rectangle(canvas, (0, 830), (W, 960), (100, 80, 60), 3)             # river border/banks
cv.line(canvas, (0, 858), (W, 858), (168, 142, 112), 2)                # ripple 1
cv.line(canvas, (0, 886), (W, 886), (168, 142, 112), 2)                # ripple 2
cv.line(canvas, (0, 914), (W, 914), (155, 130, 100), 1)                # ripple 3
...
for wx1, wx2 in [(132, 248), (462, 578), (792, 908)]:
    ...
    mx = (wx1 + wx2) // 2
    my = (wy1 + wy2) // 2
    cv.line(canvas, (mx, wy1), (mx, wy2), WIN_F, 2)
    cv.line(canvas, (wx1, my), (wx2, my), WIN_F, 2)
